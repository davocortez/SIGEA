...
function getMobileMenu() {
	...
	$('#menu').each(function() {	
				...
				var $menucontrols ="<ul id='menu-toggled-controls'><ul id='menu-toggled-title'>" + menutitle + "</div><ul id='menu-button'><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span></div></div>";
				$(this).prepend("<ul id='menu-toggled rmm-closed'>"+$menucontrols+"<ul>"+$menulist+"</ul></div>");
